...
public class HelloProxy implements org.vishakha.soap.Hello {
  private String _endpoint = null;
  private org.vishakha.soap.Hello hello = null;
  ...
  private void _initHelloProxy() {
    try {
      hello = (new org.vishakha.soap.HelloServiceLocator()).getHello();
      if (hello != null) {
        if (_endpoint != null)
  ...
  public org.vishakha.soap.Hello getHello() {
    if (hello == null)
      _initHelloProxy();
    return hello;
  }
